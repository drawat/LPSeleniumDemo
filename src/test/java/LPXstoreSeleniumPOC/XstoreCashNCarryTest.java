	...
	@Test
	  public void testXstoreCashNCarryOrder() {
		...
		try {
			...
			xlogin.searchNSelectCustomer("regularcustomer@lilly.com");
		...
		//	xlogin.skipGWPScan();
			...
			xlogin.selectGCPaymentTender();
			xlogin.enterGCNumber("202327092123");
			//xlogin.retryTender();
			xlogin.selectPinpad();
			xlogin.enterGCPin("8797");
			testEvidence.addTestStepDescriptionAndStatus("Step6:- Payment Completion", "Test Step: Passed");
			testEvidence.captureScreenshotAndAttach("Payment");
